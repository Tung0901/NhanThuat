...
def generate_actionable_script_details(primary: str, scenario_text: str, matched_units: list = None) -> dict[str, Any]:
    ...
    try:
        ...
        prompt = (
            ...
            "{\n"
            "  \"position_analysis\": \"Phân tích vị thế theo đúng cấu trúc 4 câu hỏi: "
            "(1) Chuyện gì đang thực sự xảy ra; (2) Mỗi bên thực sự muốn gì; "
            "(3) Rủi ro nếu không xử lý; (4) Hướng xử lý chính. Viết 4-6 câu ngắn, tiếng Việt đời thường, "
            "mọi thuật ngữ cổ phải giải thích ngay trong ngoặc.\",\n"
